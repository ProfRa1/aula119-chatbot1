...
word_tags_list = []
ignore_words = ['?', '!', ',', '.', "'s", "'m"]
train_data_file = open(r'C:\Users\raiss\Desktop\code_gamesss\aula119_completa\intents.json').read()
...
# Obtenha as palavras-tronco após percorrer todas as intenções
